...
class ClientAdmin(admin.ModelAdmin):
    ...
    'investment_type', 'contract_end_date')
    search_fields = ('investor_id', 'first_name', 'last_name', 'company_name')
    list_filter = ('investment_type', 'investment_date', 'contract_end_date')
    ...
    fieldsets = (
        ...
        ('Investment Details', {
            'fields': ('investment_date', 'investment_rate', 'investment_amount', 'investment_type', 'contract_end_date')
        }),
    )
